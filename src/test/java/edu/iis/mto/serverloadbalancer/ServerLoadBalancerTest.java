...
public class ServerLoadBalancerTest {
    ...
    @Test public void balancingOneServerWithEnoughRoom_getsFilledWithAllVms() {
    ...
    @Test public void aVmShouldBeBalancedOnLessServerFirst() {
    ...
    @Test public void balanceAServerWithNotEnoughRoom_shouldNotBeFilledWithAVm() {
    ...
    @Test public void balance_serversAndVms() {
        ...
        assertThat("the server 1 should contain the vm1", server1.contains(vm1));
        assertThat("the server 2 should contain the vm2", server2.contains(vm2));
        assertThat("the server 1 should contain the vm3", server1.contains(vm3));
